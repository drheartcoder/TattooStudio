    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl News Add</h3>
            </div>
            <?php echo form_open('tbl_news/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="news_image" value="<?php echo $this->input->post('news_image'); ?>" class="form-control" id="news_image" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="news_desc" class="form-control" id="news_desc"><?php echo $this->input->post('news_desc'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
