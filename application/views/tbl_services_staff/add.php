    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Services Staff Add</h3>
            </div>
            <?php echo form_open('tbl_services_staff/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fk_service_id" value="<?php echo $this->input->post('fk_service_id'); ?>" class="form-control" id="fk_service_id" />
						</div>
					</div>
					<div class="col-md-6">
