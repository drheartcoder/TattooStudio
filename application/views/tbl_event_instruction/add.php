    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Event Instruction Add</h3>
            </div>
            <?php echo form_open('tbl_event_instruction/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="instruction_name" value="<?php echo $this->input->post('instruction_name'); ?>" class="form-control" id="instruction_name" />
						</div>
					</div>
				</div>
			</div>
