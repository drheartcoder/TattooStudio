          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="admin_email" value="<?php echo $this->input->post('admin_email'); ?>" class="form-control" id="admin_email" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_contactus" class="control-label">Admin Contactus</label>
						<div class="form-group">
							<input type="text" name="admin_contactus" value="<?php echo $this->input->post('admin_contactus'); ?>" class="form-control" id="admin_contactus" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_fax" class="control-label">Admin Fax</label>
						<div class="form-group">
							<input type="text" name="admin_fax" value="<?php echo $this->input->post('admin_fax'); ?>" class="form-control" id="admin_fax" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="admin_address2" value="<?php echo $this->input->post('admin_address2'); ?>" class="form-control" id="admin_address2" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_address3" class="control-label">Admin Address3</label>
						<div class="form-group">
							<input type="text" name="admin_address3" value="<?php echo $this->input->post('admin_address3'); ?>" class="form-control" id="admin_address3" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_country" class="control-label">Admin Country</label>
						<div class="form-group">
							<input type="text" name="admin_country" value="<?php echo $this->input->post('admin_country'); ?>" class="form-control" id="admin_country" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_state" class="control-label">Admin State</label>
						<div class="form-group">
							<input type="text" name="admin_state" value="<?php echo $this->input->post('admin_state'); ?>" class="form-control" id="admin_state" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_city" class="control-label">Admin City</label>
						<div class="form-group">
							<input type="text" name="admin_city" value="<?php echo $this->input->post('admin_city'); ?>" class="form-control" id="admin_city" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_postcode" class="control-label">Admin Postcode</label>
						<div class="form-group">
							<input type="text" name="admin_postcode" value="<?php echo $this->input->post('admin_postcode'); ?>" class="form-control" id="admin_postcode" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="profile_picture" class="control-label">Profile Picture</label>
						<div class="form-group">
							<textarea name="profile_picture" class="form-control" id="profile_picture"><?php echo $this->input->post('profile_picture'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="admin_address" class="control-label">Admin Address</label>
						<div class="form-group">
							<textarea name="admin_address" class="form-control" id="admin_address"><?php echo $this->input->post('admin_address'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
