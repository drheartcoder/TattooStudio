    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Add Availibility Add</h3>
            </div>
            <?php echo form_open('tbl_add_availibility/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="date_time" value="<?php echo $this->input->post('date_time'); ?>" class="form-control" id="date_time" />
						</div>
					</div>
					<div class="col-md-6">
