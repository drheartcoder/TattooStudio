    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Service Package Add</h3>
            </div>
            <?php echo form_open('tbl_service_package/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="no_of_appointments" value="<?php echo $this->input->post('no_of_appointments'); ?>" class="form-control" id="no_of_appointments" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="expires" class="control-label">Expires</label>
						<div class="form-group">
							<input type="text" name="expires" value="<?php echo $this->input->post('expires'); ?>" class="form-control" id="expires" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="package_details" class="control-label">Package Details</label>
						<div class="form-group">
							<input type="text" name="package_details" value="<?php echo $this->input->post('package_details'); ?>" class="form-control" id="package_details" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="can_be_used_for" class="form-control" id="can_be_used_for"><?php echo $this->input->post('can_be_used_for'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
