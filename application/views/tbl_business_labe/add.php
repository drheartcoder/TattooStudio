    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Business Labe Add</h3>
            </div>
            <?php echo form_open('tbl_business_labe/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="label_name" value="<?php echo $this->input->post('label_name'); ?>" class="form-control" id="label_name" />
						</div>
					</div>
					<div class="col-md-6">
