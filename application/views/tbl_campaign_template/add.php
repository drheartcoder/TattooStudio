    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Campaign Template Add</h3>
            </div>
            <?php echo form_open('tbl_campaign_template/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="campaign_id" class="control-label">Campaign Id</label>
						<div class="form-group">
							<input type="text" name="campaign_id" value="<?php echo $this->input->post('campaign_id'); ?>" class="form-control" id="campaign_id" />
						</div>
					</div>
					<div class="col-md-6">
