    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Gift Card Add</h3>
            </div>
            <?php echo form_open('tbl_gift_card/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="recipient_email" value="<?php echo $this->input->post('recipient_email'); ?>" class="form-control" id="recipient_email" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="recipient_user_id" class="control-label">Recipient User Id</label>
						<div class="form-group">
							<input type="text" name="recipient_user_id" value="<?php echo $this->input->post('recipient_user_id'); ?>" class="form-control" id="recipient_user_id" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gift_type" class="control-label">Gift Type</label>
						<div class="form-group">
							<input type="text" name="gift_type" value="<?php echo $this->input->post('gift_type'); ?>" class="form-control" id="gift_type" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="remaining_amount" value="<?php echo $this->input->post('remaining_amount'); ?>" class="form-control" id="remaining_amount" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="gift_card_token" class="control-label">Gift Card Token</label>
						<div class="form-group">
							<input type="text" name="gift_card_token" value="<?php echo $this->input->post('gift_card_token'); ?>" class="form-control" id="gift_card_token" />
						</div>
					</div>
					<div class="col-md-6">
