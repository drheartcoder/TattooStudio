    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Favorite Add</h3>
            </div>
            <?php echo form_open('tbl_favorite/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="favorite_link" value="<?php echo $this->input->post('favorite_link'); ?>" class="form-control" id="favorite_link" />
						</div>
					</div>
				</div>
			</div>
