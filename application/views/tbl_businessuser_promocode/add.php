    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Businessuser Promocode Add</h3>
            </div>
            <?php echo form_open('tbl_businessuser_promocode/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="promo_nickname" value="<?php echo $this->input->post('promo_nickname'); ?>" class="form-control" id="promo_nickname" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="discount_type" value="<?php echo $this->input->post('discount_type'); ?>" class="form-control" id="discount_type" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="promo_start_date" class="control-label">Promo Start Date</label>
						<div class="form-group">
							<input type="text" name="promo_start_date" value="<?php echo $this->input->post('promo_start_date'); ?>" class="has-datepicker form-control" id="promo_start_date" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="promo_end_date" class="control-label">Promo End Date</label>
						<div class="form-group">
							<input type="text" name="promo_end_date" value="<?php echo $this->input->post('promo_end_date'); ?>" class="has-datepicker form-control" id="promo_end_date" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="one_use" class="control-label">One Use</label>
						<div class="form-group">
							<input type="text" name="one_use" value="<?php echo $this->input->post('one_use'); ?>" class="form-control" id="one_use" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="new_client" class="control-label">New Client</label>
						<div class="form-group">
							<input type="text" name="new_client" value="<?php echo $this->input->post('new_client'); ?>" class="form-control" id="new_client" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="promo_location" class="control-label">Promo Location</label>
						<div class="form-group">
							<input type="text" name="promo_location" value="<?php echo $this->input->post('promo_location'); ?>" class="form-control" id="promo_location" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="promo_staff" class="control-label">Promo Staff</label>
						<div class="form-group">
							<input type="text" name="promo_staff" value="<?php echo $this->input->post('promo_staff'); ?>" class="form-control" id="promo_staff" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="promo_services" class="control-label">Promo Services</label>
						<div class="form-group">
							<input type="text" name="promo_services" value="<?php echo $this->input->post('promo_services'); ?>" class="form-control" id="promo_services" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="promocode_status" class="control-label">Promocode Status</label>
						<div class="form-group">
							<input type="text" name="promocode_status" value="<?php echo $this->input->post('promocode_status'); ?>" class="form-control" id="promocode_status" />
						</div>
					</div>
					<div class="col-md-6">
