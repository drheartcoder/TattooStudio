    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Client Custom Price Add</h3>
            </div>
            <?php echo form_open('tbl_client_custom_price/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="custom_price" value="<?php echo $this->input->post('custom_price'); ?>" class="form-control" id="custom_price" />
						</div>
					</div>
				</div>
			</div>
