    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Testimonial Add</h3>
            </div>
            <?php echo form_open('tbl_testimonial/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="name" class="form-control" id="name"><?php echo $this->input->post('name'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
