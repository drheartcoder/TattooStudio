    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tbl Appoinment Add</h3>
            </div>
            <?php echo form_open('tbl_appoinment/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="deal_id" class="control-label">Deal Id</label>
						<div class="form-group">
							<input type="text" name="deal_id" value="<?php echo $this->input->post('deal_id'); ?>" class="form-control" id="deal_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fk_business_service_id" value="<?php echo $this->input->post('fk_business_service_id'); ?>" class="form-control" id="fk_business_service_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fk_package_id" value="<?php echo $this->input->post('fk_package_id'); ?>" class="form-control" id="fk_package_id" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="service_cost" class="control-label">Service Cost</label>
						<div class="form-group">
							<input type="text" name="service_cost" value="<?php echo $this->input->post('service_cost'); ?>" class="form-control" id="service_cost" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="total_cost" class="control-label">Total Cost</label>
						<div class="form-group">
							<input type="text" name="total_cost" value="<?php echo $this->input->post('total_cost'); ?>" class="form-control" id="total_cost" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_date" class="control-label">Apt Date</label>
						<div class="form-group">
							<input type="text" name="apt_date" value="<?php echo $this->input->post('apt_date'); ?>" class="has-datepicker form-control" id="apt_date" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_time" class="control-label">Apt Time</label>
						<div class="form-group">
							<input type="text" name="apt_time" value="<?php echo $this->input->post('apt_time'); ?>" class="form-control" id="apt_time" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="end_apt_time" class="control-label">End Apt Time</label>
						<div class="form-group">
							<input type="text" name="end_apt_time" value="<?php echo $this->input->post('end_apt_time'); ?>" class="form-control" id="end_apt_time" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="card_token" value="<?php echo $this->input->post('card_token'); ?>" class="form-control" id="card_token" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="transaction_ref_token" class="control-label">Transaction Ref Token</label>
						<div class="form-group">
							<input type="text" name="transaction_ref_token" value="<?php echo $this->input->post('transaction_ref_token'); ?>" class="form-control" id="transaction_ref_token" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="transaction_date_time" class="control-label">Transaction Date Time</label>
						<div class="form-group">
							<input type="text" name="transaction_date_time" value="<?php echo $this->input->post('transaction_date_time'); ?>" class="form-control" id="transaction_date_time" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="transaction_correlation_id" class="control-label">Transaction Correlation Id</label>
						<div class="form-group">
							<input type="text" name="transaction_correlation_id" value="<?php echo $this->input->post('transaction_correlation_id'); ?>" class="form-control" id="transaction_correlation_id" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_repeat_status" class="control-label">Apt Repeat Status</label>
						<div class="form-group">
							<input type="text" name="apt_repeat_status" value="<?php echo $this->input->post('apt_repeat_status'); ?>" class="form-control" id="apt_repeat_status" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_repeat_more_count" class="control-label">Apt Repeat More Count</label>
						<div class="form-group">
							<input type="text" name="apt_repeat_more_count" value="<?php echo $this->input->post('apt_repeat_more_count'); ?>" class="form-control" id="apt_repeat_more_count" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_repeat_more_type" class="control-label">Apt Repeat More Type</label>
						<div class="form-group">
							<input type="text" name="apt_repeat_more_type" value="<?php echo $this->input->post('apt_repeat_more_type'); ?>" class="form-control" id="apt_repeat_more_type" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_repeat_end" class="control-label">Apt Repeat End</label>
						<div class="form-group">
							<input type="text" name="apt_repeat_end" value="<?php echo $this->input->post('apt_repeat_end'); ?>" class="form-control" id="apt_repeat_end" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_repeat_end_date" class="control-label">Apt Repeat End Date</label>
						<div class="form-group">
							<input type="text" name="apt_repeat_end_date" value="<?php echo $this->input->post('apt_repeat_end_date'); ?>" class="form-control" id="apt_repeat_end_date" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="apt_status" class="control-label">Apt Status</label>
						<div class="form-group">
							<input type="text" name="apt_status" value="<?php echo $this->input->post('apt_status'); ?>" class="form-control" id="apt_status" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="payment_status" class="control-label">Payment Status</label>
						<div class="form-group">
							<input type="text" name="payment_status" value="<?php echo $this->input->post('payment_status'); ?>" class="form-control" id="payment_status" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="confirmed_status" class="control-label">Confirmed Status</label>
						<div class="form-group">
							<input type="text" name="confirmed_status" value="<?php echo $this->input->post('confirmed_status'); ?>" class="form-control" id="confirmed_status" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="refTransactionId" class="control-label">RefTransactionId</label>
						<div class="form-group">
							<input type="text" name="refTransactionId" value="<?php echo $this->input->post('refTransactionId'); ?>" class="form-control" id="refTransactionId" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="refTransactionDate" class="control-label">RefTransactionDate</label>
						<div class="form-group">
							<input type="text" name="refTransactionDate" value="<?php echo $this->input->post('refTransactionDate'); ?>" class="form-control" id="refTransactionDate" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="refAmount" class="control-label">RefAmount</label>
						<div class="form-group">
							<input type="text" name="refAmount" value="<?php echo $this->input->post('refAmount'); ?>" class="form-control" id="refAmount" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="is_recurring" class="control-label">Is Recurring</label>
						<div class="form-group">
							<input type="text" name="is_recurring" value="<?php echo $this->input->post('is_recurring'); ?>" class="form-control" id="is_recurring" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="recurring_parent" class="control-label">Recurring Parent</label>
						<div class="form-group">
							<input type="text" name="recurring_parent" value="<?php echo $this->input->post('recurring_parent'); ?>" class="form-control" id="recurring_parent" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="is_present" value="<?php echo $this->input->post('is_present'); ?>" class="form-control" id="is_present" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="apt_note" class="form-control" id="apt_note"><?php echo $this->input->post('apt_note'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="recurring_data" class="form-control" id="recurring_data"><?php echo $this->input->post('recurring_data'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
